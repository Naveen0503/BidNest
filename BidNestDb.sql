...
INSERT INTO Users ( Username, Email, Password, FirstName, LastName, Address, PhoneNumber, DateOfBirth, RegistrationDate, Role, IsActive, LastLoginDate)
VALUES
    ('seller1', 'seller1@email.com', 'sellerpass', 'John', 'Doe', '123 Main St', '123-456-7890', '1990-01-15', '2022-01-01 08:00:00', 'Seller', 1, '2022-01-10 12:30:00'),
    ('bidder1', 'bidder1@email.com', 'bidderpass', 'Jane', 'Smith', '456 Oak Ave', '987-654-3210', '1985-05-22', '2022-01-02 10:15:00', 'Bidder', 1, '2022-01-11 09:45:00');

INSERT INTO Items (SellerID, Title, Description, StartDate, EndDate, InitialAmount, ClosingAmount, CurrentBidAmount)
VALUES
    ( 1, 'Laptop', 'Brand new laptop', '2022-02-01 12:00:00', '2022-02-10 18:00:00', 500.00, 0.00, 0.00),
    ( 1, 'Smartphone', 'Latest smartphone model', '2022-02-05 09:00:00', '2022-02-15 15:00:00', 300.00, 0.00, 0.00),
    ( 1, 'Camera', 'Professional camera', '2022-02-10 15:00:00', '2022-02-20 20:00:00', 800.00, 0.00, 0.00);
INSERT INTO Bids ( BidderID, ItemID, BidAmount, BidTime)
VALUES
    ( 2, 1, 550.00, '2022-02-05 14:30:00'),
    ( 2, 2, 320.00, '2022-02-10 10:45:00'),
    ( 2, 3, 850.00, '2022-02-15 18:30:00');
-- Assuming binary image data for simplicity (replace with actual binary data)
INSERT INTO ItemImages (ItemID, ImageData)
VALUES
    ( 1, 0x0123456789ABCDEF),
    ( 2, 0xFEDCBA9876543210),
    ( 3, 0xA1B2C3D4E5F67890);
